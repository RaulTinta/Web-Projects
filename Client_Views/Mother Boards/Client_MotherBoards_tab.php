...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="Client_MotherBoards_tab.php" method="GET">
      <div style="text-align: center;">
        <div style="display: flex; justify-content: center; align-items: center;">
          ...
          <button type="button" class="button secondary" onclick="location.href='Client_MotherBoards_tab.php';"><b>Reset</b></button>
        </div>
      </div>
    </form>
