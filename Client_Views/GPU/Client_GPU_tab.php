...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="Client_GPU_tab.php" method="GET">
      <div style="text-align: center;">
        <div style="display: flex; justify-content: center; align-items: center;">
          ...
          <button type="button" class="button secondary" onclick="location.href='Client_GPU_tab.php';"><b>Reset</b></button>
        </div>
      </div>
    </form>
    ...
    <div class="row">
        ...
        <table  class="unstriped">
          <thead>
            <tr>
              ...
              <th width="150">GPU Boost Clock</th>
              <th width="150">Tip Memorie</th>
              <th width="150">Dimensiune Memorie</th>
     ...
     <div class="row">
      <div class="columns large-6 medium-6 small-12 text-right">
        <a href="Admin_GPU_AdaugareForm.php" class="button"><b>Adauga produs</b></a>
      </div>
    </div>
     <hr />
