...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO CPU (imagine, descriere, seria, nucleu, frecventa, tehnologie_fabricatie, pret) VALUES (?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("ssssssd", $imagine, $descriere, $seria, $nucleu, $frecventa, $tehnologie_fabricatie, $pret);
...
if ($stmt->execute()) {
    ...
    header("Location: Admin_CPU_tab.php");
} else {
