    ...
    <form action="Update.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          ...
          <input type="text" name="soclu_procesor" value="<?php echo htmlspecialchars($row['soclu_procesor']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Producator chipset</label>
          <input type="text" name="chipset_producator" value="<?php echo htmlspecialchars($row['chipset_producator']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Model chipset</label>
          <input type="text" name="chipset_model" value="<?php echo htmlspecialchars($row['chipset_model']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Tip memorie</label>
          <input type="text" name="tip_memorie" value="<?php echo htmlspecialchars($row['tip_memorie']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
