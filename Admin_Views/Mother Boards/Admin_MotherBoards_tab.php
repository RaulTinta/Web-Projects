...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="Admin_MotherBoards_tab.php" method="GET">
      <div style="text-align: center;">
        <div style="display: flex; justify-content: center; align-items: center;">
          ...
          <button type="button" class="button secondary" onclick="location.href='Admin_MotherBoards_tab.php';"><b>Reset</b></button>
        </div>
      </div>
    </form>
    ...
    <div class="row">
        ...
        <table  class="unstriped">
          <thead>
            <tr>
              ...
              <th width="150">Soclu procesor</th>
              <th width="150">Producator chipset</th>
              <th width="150">Model chipset</th>
              <th width="150">Tip memorie</th>
     ...
     <div class="row">
      <div class="columns large-6 medium-6 small-12 text-right">
        <a href="Admin_MotherBoards_AdaugareForm.php" class="button"><b>Adauga produs</b></a>
      </div>
    </div>
     <hr />
