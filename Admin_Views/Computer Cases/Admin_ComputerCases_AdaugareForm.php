...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <hr />
    <center><h5><b>Introduceti datele despre noul produ:</b></h5></center>
    <form action="Adaugare.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          ...
          <input type="text" name="tip_carcasa"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Dimensiune (H x D x W)</label>
          <input type="text" name="dimensiune"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Sloturi expansiune</label>
          <input type="text" name="sloturi_expansiune"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
