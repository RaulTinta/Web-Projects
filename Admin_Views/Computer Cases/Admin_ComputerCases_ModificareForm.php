...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php
      ...
      // Fetching data
      $sql = "SELECT * FROM computercases WHERE id = ?";
    ...
    <form action="Update.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Tip Carcasa</label>
          <input type="text" name="tip_carcasa" value="<?php echo htmlspecialchars($row['tip_carcasa']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Dimensiune (H x D x W)</label>
          <input type="text" name="dimensiune" value="<?php echo htmlspecialchars($row['dimensiune']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Sloturi Expansiune</label>
          <input type="text" name="sloturi_expansiune" value="<?php echo htmlspecialchars($row['sloturi_expansiune']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
