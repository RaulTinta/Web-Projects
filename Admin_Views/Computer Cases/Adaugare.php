...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO ComputerCases (imagine, descriere, tip_carcasa, dimensiune, sloturi_expansiune, pret) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("sssssd", $imagine, $descriere, $tip_carcasa, $dimensiune, $sloturi_expansiune, $pret);
...
if ($stmt->execute()) {
    ...
    header("Location: Admin_ComputerCases_tab.php");
} else {
