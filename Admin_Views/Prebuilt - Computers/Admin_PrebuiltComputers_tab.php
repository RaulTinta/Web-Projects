...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="Admin_PrebuiltComputers_tab.php" method="GET">
      <div style="text-align: center;">
        <div style="display: flex; justify-content: center; align-items: center;">
          ...
          <button type="button" class="button secondary" onclick="location.href='Admin_PrebuiltComputers_tab.php';"><b>Reset</b></button>
        </div>
      </div>
    </form>
    ...
    <div class="row">
        ...
        <table  class="unstriped">
          <thead>
            <tr>
              ...
              <th width="150">Model CPU</th>
              <th width="150">Model GPU</th>
              <th width="150">Chipset</th>
              <th width="150">Capacitate RAM</th>
              <th width="100">Pret</th>
              <th width="100">Discountt</th>
              <th></th>
            </tr>
          </thead>
          <tbody>
     ...
     <div class="row">
      <div class="columns large-6 medium-6 small-12 text-right">
        <a href="Admin_PrebuiltComputers_AdaugareForm.php" class="button"><b>Adauga produs</b></a>
      </div>
    </div>
     <hr />
