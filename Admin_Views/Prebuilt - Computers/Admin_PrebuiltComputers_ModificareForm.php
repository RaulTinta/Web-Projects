...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php
      ...
      // Fetching data
      $sql = "SELECT * FROM PrebuiltComputers WHERE id = ?";
    ...
    <form action="Update.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          ...
          <input type="text" name="model_cpu" value="<?php echo htmlspecialchars($row['model_cpu']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Model GPU</label>
          <input type="text" name="model_gpu" value="<?php echo htmlspecialchars($row['model_gpu']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Chipset</label>
          <input type="text" name="chipset" value="<?php echo htmlspecialchars($row['chipset']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Capacitate RAM</label>
          <input type="text" name="capacitate_ram" value="<?php echo htmlspecialchars($row['capacitate_ram']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          ...
          <input type="text" name="discount" value="<?php echo htmlspecialchars($row['discount']); ?>"/>
        </div>
      </div>
