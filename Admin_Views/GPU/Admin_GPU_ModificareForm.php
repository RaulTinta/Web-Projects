...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="Update.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>GPU Boost Clock</label>
          <input type="text" name="boost_clock" value="<?php echo htmlspecialchars($row['boost_clock']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Dimensiune Memorie</label>
          <input type="text" name="dimensiune_memorie" value="<?php echo htmlspecialchars($row['dimensiune_memorie']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
