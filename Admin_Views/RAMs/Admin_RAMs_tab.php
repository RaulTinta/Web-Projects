...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="Admin_RAMs_tab.php" method="GET">
      <div style="text-align: center;">
        <div style="display: flex; justify-content: center; align-items: center;">
          ...
          <button type="button" class="button secondary" onclick="location.href='Admin_RAMs_tab.php';"><b>Reset</b></button>
        </div>
      </div>
    </form>
    ...
    <div class="row">
        ...
        <table  class="unstriped">
          <thead>
            <tr>
              ...
              <th width="150">Tip</th>
              <th width="150">Capacitate</th>
              <th width="150">Frecventa</th>
              <th width="150">Latenta CAS</th>
     ...
     <div class="row">
      <div class="columns large-6 medium-6 small-12 text-right">
        <a href="Admin_RAMs_AdaugareForm_tab.php" class="button"><b>Adauga produs</b></a>
      </div>
    </div>
     <hr />
