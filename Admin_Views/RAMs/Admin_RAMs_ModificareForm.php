  ...
  <body>
    ...
    <form action="Update.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Tip</label>
          <input type="text" name="tip" value="<?php echo htmlspecialchars($row['tip']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Capacitate</label>
          <input type="text" name="capacitate" value="<?php echo htmlspecialchars($row['capacitate']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
      ...
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
          <label>Latenta CSP</label>
          <input type="text" name="latenta_cas" value="<?php echo htmlspecialchars($row['latenta_cas']); ?>"/>
        </div>
      </div>
      <div class="row">
        <div class="columns large-centered large-5 medium-5 medium-centered small-12 small-centered cell">
